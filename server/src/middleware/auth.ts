...
// Extend Express Request to carry decoded Firebase token claims
declare global {
  namespace Express {
    interface Request {
      user?: {
...
let adminApp: any = null; // eslint-disable-line @typescript-eslint/no-explicit-any
let authInstance: any = null; // eslint-disable-line @typescript-eslint/no-explicit-any
